...
-- CONJUNCTIONS
  andSg_Conj = {s1 = [] ; s2 = "och" ; n = Sg ; isDiscont = False} ;
  comma_and_Conj = {s1 = [] ; s2 = ", och" ; n = Pl ; isDiscont = False} ;
  if_comma_then_Conj = {s1 = "om" ; s2 = "så" ; n = Sg ; isDiscont = False} ;
  semicolon_and_Conj = {s1 = [] ; s2 = "; och" ; n = Pl ; isDiscont = False} ;
